package br.ufc.crateus.jander.googlemaps;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng ufcCrateus = new LatLng(-5.1864371, -40.6452647);
        mMap.setMinZoomPreference(15);
        mMap.setMaxZoomPreference(20);
        mMap.addMarker(new MarkerOptions().position(ufcCrateus).title("UFC Crateús").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_VIOLET)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(ufcCrateus));
    }
